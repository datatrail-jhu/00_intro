...
![LinkedIn website](images/04_other_accounts/04_cdsintro_other_accounts-3.png)
...
![LinkedIn Blank Form](images/04_other_accounts/04_cdsintro_other_accounts-4.png)
...
![Not a robot](images/04_other_accounts/04_cdsintro_other_accounts-7.png)
...
![gmail website](images/04_other_accounts/04_cdsintro_other_accounts-10.png)

This will bring you to your email account. An email from 'LinkedIn Messages' should be there. Click on that email to open it.

![Verify email from LinkedIn](images/04_other_accounts/04_cdsintro_other_accounts-12.png)

In that email there will be a button where you can click to 'Confirm your email'. 

![LinkedIn Confirm Your Email](images/04_other_accounts/04_cdsintro_other_accounts-13.png)

This will open a new screen where your google username will be in the box already. Click 'Continue' on this screen. 

![LinkedIn Continue](images/04_other_accounts/04_cdsintro_other_accounts-14.png)
...
![Twitter website](images/04_other_accounts/04_cdsintro_other_accounts-17.png)

This will bring you to a screen where at the top right you'll want to click 'Sign up'. 

![Twitter sign in](images/04_other_accounts/04_cdsintro_other_accounts-18.png)
...
![Twitter phone number](images/04_other_accounts/04_cdsintro_other_accounts-20.png)
...
![Twitter username](images/04_other_accounts/04_cdsintro_other_accounts-21.png)
...
![Twitter Let's go!](images/04_other_accounts/04_cdsintro_other_accounts-24.png)
In this email, there will be a 'Confirm now' button to click. To verify your Twitter account, click on this button.
![Twitter Confirm now](images/04_other_accounts/04_cdsintro_other_accounts-25.png)
...
![Slack Web Address](images/04_other_accounts/04_cdsintro_other_accounts-28.png)

On this webpage, type your Gmail address in the 'email address' box, and click 'GET STARTED.'

![Slack Get Started!](images/04_other_accounts/04_cdsintro_other_accounts-29.png)
...
![rstudio.cloud web address](images/04_other_accounts/04_cdsintro_other_accounts-32.png)
...
![rstudio.cloud sign up with Google](images/04_other_accounts/04_cdsintro_other_accounts-34.png)
...
![rstudio.cloud choose account](images/04_other_accounts/04_cdsintro_other_accounts-35.png)
...
![DataCamp Web Address](images/04_other_accounts/04_cdsintro_other_accounts-39.png)
...
![DataCamp Google+](images/04_other_accounts/04_cdsintro_other_accounts-40.png)

Select your Google account. 

![DataCamp choose account](images/04_other_accounts/04_cdsintro_other_accounts-41.png)
...
![GitHub web address](images/04_other_accounts/04_cdsintro_other_accounts-44.png)
...
![GitHub sign up](images/04_other_accounts/04_cdsintro_other_accounts-45.png)
One fianl note about GitHub usernames in particular. This will be used for your website (which you'll build later) and *all* the code you write. You'll use GitHub a lot, so this is a case where it is particularly helpful to choose a good username, particularly one that has something to do with your name and not much else. For example, the person writing this lesson is named Shannon Ellis. Her GitHub username is "ShanEllis." While it is *possible* to change your GitHub username down the line, it's a bit of a pain, so choose wisely now!
